# webCrawling
Web crawling using hueristic search (A* and Greedy Best-First Search Algorithm) [To be combined with other part of the project]
...
└── examples/
└── sample_run.py # Example usage of the crawler
```
...
```
The crawler will print the pages visited and the path followed based on the GBFS heuristic

## Edit config.py to set:

- START_URL – The initial page to start crawling from.

- TARGET_KEYWORDS – List of keywords for heuristic prioritization.

- MAX_DEPTH – Maximum depth of crawling to avoid infinite loops.
